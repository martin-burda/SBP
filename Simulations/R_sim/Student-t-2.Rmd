...
z_mat_3d <- pmin(z_mat_3d, 10) # Truncate at 10 for better visualization
...
z_mat_2d[is.infinite(z_mat_2d)] <- NaN # Replace INF entries with NaN
z_mat_2d <- pmin(z_mat_2d, 10) # Truncate at 10 for better visualization
...
plot_file = paste0("../graphs_sim/Studentt2_true.png")
