...
z_mat_3d <- pmin(z_mat_3d, 5) # Truncate to see the contours change
...
plot_file = paste0("../graphs_sim/Gaussian2_true.png")
...
ggplot(cs_EDF, aes(x=U1, y=U2)) +
  geom_point(alpha=0.5, size=0.5) + coord_fixed(ratio=1) +               
  labs(title = "Copula Sample with RANK\nestimate of empirical CDFs", 
